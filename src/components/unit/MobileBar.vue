  ...
  <div class="p-5">
    <div class="b-bar">
      <template v-if="isDetailPage">
        <button
          type="button"
          class="w-[70px] h-[70px] flex flex-col items-center justify-center cursor-pointer pc:hover:text-neonpink bg-white/30 rounded-full backdrop-blur-[5px] border border-white/30 shadow-[2px_2px_5px_rgba(0,0,0,0.2),inset_1px_1px_5px_rgba(255,255,255,0.5)]"
          @click="goBack"
        >
      ...
      <template v-else>
        <div class="w-full">
          ...
          >
          <router-link to="/" class="min-w-[40px] flex flex-col items-center cursor-pointer pc:hover:text-neonpink">
          ...
          <router-link to="/favorite" class="min-w-[40px] flex flex-col items-center cursor-pointer pc:hover:text-neonpink">
