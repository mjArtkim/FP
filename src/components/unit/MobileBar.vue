...
<template>
  <div class="p-5 w-full">
    <div class="b-bar py-[10px] px-6 flex justify-between items-center w-full relative overflow-hidden bg-white/30 rounded-full backdrop-blur-[5px] border border-white/30 shadow-[2px_2px_5px_rgba(0,0,0,0.2),inset_1px_1px_5px_rgba(255,255,255,0.5)]">
